...
class Program
{
    static void Main()
    {
                ...
                while (true)
                {
                    ...
                    if (cartChoice == "1")
                    {
                            ...
                            && removeIndex >= 1 && removeIndex <= cartItems.Count)
                        {
                            ...
                            productStock[productIndex] += cartQty[actualIndex]; 
        ...
        while (true)
        {
            ...
            if (!decimal.TryParse(paymentInput, out payment))
            {
        ...
        orderHistory.Add($"Receipt No: {receiptNumber:D4} | Date: {DateTime.Now} | Final Total: PHP {total}");
        receiptNumber++;
